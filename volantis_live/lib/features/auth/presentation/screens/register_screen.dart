...
class _PasswordRequirements extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        _RequirementRow(label: 'At least 8 characters', isMet: hasMin8Chars),
        const SizedBox(height: 4),
        _RequirementRow(label: '1 capital letter (A-Z)', isMet: hasCapital),
        const SizedBox(height: 4),
        _RequirementRow(label: '1 small letter (a-z)', isMet: hasSmall),
        const SizedBox(height: 4),
        _RequirementRow(label: '1 number (0-9)', isMet: hasNumber),
        const SizedBox(height: 4),
        _RequirementRow(
